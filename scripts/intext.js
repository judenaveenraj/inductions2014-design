...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '',
  browsersupport: '0',
  appsig: 'S20141399311257z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  checksb: 0,
  branduid: 'fe989fc3225e95b49d73b2e70954ee5c|1398338080',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://deltainductions.nitt.edu/home/app_dev/app_dev_discussions/+login',
  page_url: '?',
  refer_domain: 'deltainductions.nitt.edu',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '117.238.153.177'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 117.238.153.177 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://deltainductions.nitt.edu/home/app_dev/app_dev_discussions/+login'; */
    properties.page_domain=''; /* 'deltainductions.nitt.edu'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('s4z1y0pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg s4z1y0_3, s4z1y0_4, ... s4z1y0_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 's4z1y0';
     span.id = 's4z1y0' + "_" + properties.spancount;
     span.name='s4z1y0' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 's4z1y0spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClicks4z1y0,   false);
  addEvent(adpop_span, "click", doMouseClicks4z1y0);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 's4z1y0frame';
  gframe.name = 's4z1y0frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('s4z1y0frame');
 ...
 function setups4z1y0CSS()
 {
  writeLog(1, 'setups4z1y0CSS()');
  ...
  // style.innerHTML = '.s4z1y0 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.s4z1y0 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.s4z1y0 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.s4z1y0 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.s4z1y0 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
